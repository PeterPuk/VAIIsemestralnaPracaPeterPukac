...
<div class="top-bar nav-down">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6"><!-- Zaciatok -->
...
tel: 0907 071 723</a>
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-2">
                <a href="PrihlasenyZakaznikProfil.php" class="hlavne">
                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor"
...
Profil</a>
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-2">
                <a href="Prihlasenie.php" class="hlavne">
                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor"
                         class="bi bi-bag-check" viewBox="-15.15 -4 30 30">
    ...
    <div class="row">
        <div class="col-12">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand" href="SneakFieldPrihlasenyZakaznik.html">
