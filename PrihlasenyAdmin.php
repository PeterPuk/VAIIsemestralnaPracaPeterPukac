...
<div class="top-bar nav-down">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-8"><!-- Zaciatok -->
                <a href="tel:0907071723" class="hlavne">
                    <!--<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-telephone" viewBox="-13 -4 30 30">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor"
                         class="bi bi-phone" viewBox="-14 -4 30 30">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-2">
                <a href="Prihlasenie.php" class="hlavne">
                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor"
                         class="bi bi-person" viewBox="-14 -4 30 30">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-2">
                <a href="Prihlasenie.php" class="hlavne">
                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70"fill="currentColor" class="bi bi-person-x" viewBox="-14 -4 30 30">
...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>
                    Ste prihhlásený ako administrátor.
                </h1>
