...
<head>
    ...
    <link rel="stylesheet" href="registraciaCss.css">
</head>
...
<div class="top-bar nav-down">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-8 col-xl-8"><!-- Zaciatok -->
                <a href="tel:0907071723" class="hlavne">tel: 0907 071 723 </a>
            </div>

            <div class="col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2">
                <a href="Prihlasenie.html" class="hlavne">Prihlásenie</a>
            </div>
            <div class="col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2">
                <a href="#" class="hlavne">Registrácia</a>
            </div>
            <!-- Koniec -->
        </div>
    </div>
